...
Public Class frmMain
    ...
    Private Sub main_form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        keyComFirstKey.Items.Add("Ctrl")
        keyComFirstKey.Items.Add("Alt")
        keyComFirstKey.Items.Add("Shift")

        keyComFirstKey.Items.Add("ESC")
        'keyComFirstKey.Items.Add("Windows")

        keyComFirstKey.Items.Add("Delete")
        keyComFirstKey.Items.Add("Backspace")
        'Arrow Keys
        keyComFirstKey.Items.Add("Up Arrow")
        keyComFirstKey.Items.Add("Down Arrow")
        keyComFirstKey.Items.Add("Left Arrow")
        keyComFirstKey.Items.Add("Right Arrow")

        keyComFirstKey.Items.Add("Home")
        keyComFirstKey.Items.Add("End")
        keyComFirstKey.Items.Add("Insert")
        keyComFirstKey.Items.Add("Page Up")
        keyComFirstKey.Items.Add("Page Down")

        'Function Keys
        keyComFirstKey.Items.Add("F1")
        keyComFirstKey.Items.Add("F2")
        keyComFirstKey.Items.Add("F3")
        keyComFirstKey.Items.Add("F4")
        keyComFirstKey.Items.Add("F5")
        keyComFirstKey.Items.Add("F6")
        keyComFirstKey.Items.Add("F7")
        keyComFirstKey.Items.Add("F8")
        keyComFirstKey.Items.Add("F9")
        keyComFirstKey.Items.Add("F10")
        keyComFirstKey.Items.Add("F11")
        keyComFirstKey.Items.Add("F12")
        ...
        keyComSecondKey.Items.Add("Ctrl")
        keyComSecondKey.Items.Add("Alt")
        keyComSecondKey.Items.Add("Shift")

        keyComSecondKey.Items.Add("ESC")
        'keyComSecondKey.Items.Add("Windows")

        keyComSecondKey.Items.Add("Delete")
        keyComSecondKey.Items.Add("Backspace")
        'Arrow Keys
        keyComSecondKey.Items.Add("Up Arrow")
        keyComSecondKey.Items.Add("Down Arrow")
        keyComSecondKey.Items.Add("Left Arrow")
        keyComSecondKey.Items.Add("Right Arrow")

        keyComSecondKey.Items.Add("Home")
        keyComSecondKey.Items.Add("End")
        keyComSecondKey.Items.Add("Insert")
        keyComSecondKey.Items.Add("Page Up")
        keyComSecondKey.Items.Add("Page Down")

        'Function Keys
        keyComSecondKey.Items.Add("F1")
        keyComSecondKey.Items.Add("F2")
        keyComSecondKey.Items.Add("F3")
        keyComSecondKey.Items.Add("F4")
        keyComSecondKey.Items.Add("F5")
        keyComSecondKey.Items.Add("F6")
        keyComSecondKey.Items.Add("F7")
        keyComSecondKey.Items.Add("F8")
        keyComSecondKey.Items.Add("F9")
        keyComSecondKey.Items.Add("F10")
        keyComSecondKey.Items.Add("F11")
        keyComSecondKey.Items.Add("F12")
    ...
    Private Sub keyComFirstKey_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles keyComFirstKey.SelectedIndexChanged
        ...
        'Control, Alt and Shift
        If keyComFirstKey.Text = "Ctrl" Then
            keyComSelectedFirstKey = "^"
        End If
        If keyComFirstKey.Text = "Alt" Then
            keyComSelectedFirstKey = "%"
        End If
        If keyComFirstKey.Text = "Shift" Then
            keyComSelectedFirstKey = "+"
        End If

        If keyComFirstKey.Text = "ESC" Then
            keyComSelectedFirstKey = "{ESC}"
        End If
        'If keyComFirstKey.Text = "Windows" Then
        '    keyComSelectedFirstKey = "{WINDOWS}"
        'End If
        If keyComFirstKey.Text = "Delete" Then
            keyComSelectedFirstKey = "{DELETE}"
        End If
        If keyComFirstKey.Text = "Backspace" Then
            keyComSelectedFirstKey = "{BKSP}"
        End If
        'Arrow Keys
        If keyComFirstKey.Text = "Down Arrow" Then
            keyComSelectedFirstKey = "{DOWN}"
        End If
        If keyComFirstKey.Text = "Up Arrow" Then
            keyComSelectedFirstKey = "{UP}"
        End If
        If keyComFirstKey.Text = "Left Arrow" Then
            keyComSelectedFirstKey = "{LEFT}"
        End If
        If keyComFirstKey.Text = "Right Arrow" Then
            keyComSelectedFirstKey = "{RIGHT}"
        End If
        'Home End Insert
        If keyComFirstKey.Text = "Home" Then
            keyComSelectedFirstKey = "{Home}"
        End If
        If keyComFirstKey.Text = "End" Then
            keyComSelectedFirstKey = "{End}"
        End If
        If keyComFirstKey.Text = "Insert" Then
            keyComSelectedFirstKey = "{INSERT}"
        End If
        'Page up and page down
        If keyComFirstKey.Text = "Page Up" Then
            keyComSelectedFirstKey = "{PGUP}"
        End If
        If keyComFirstKey.Text = "Page Down" Then
            keyComSelectedFirstKey = "{PGDN}"
        End If
        If keyComFirstKey.Text = "Print Screen" Then
            keyComSelectedFirstKey = "{PRTSC}"
        End If
        'Function Keys F1 to F12
        If keyComFirstKey.Text = "F1" Then
            keyComSelectedFirstKey = "{F1}"
        End If
        If keyComFirstKey.Text = "F2" Then
            keyComSelectedFirstKey = "{F2}"
        End If
        If keyComFirstKey.Text = "F3" Then
            keyComSelectedFirstKey = "{F3}"
        End If
        If keyComFirstKey.Text = "F4" Then
            keyComSelectedFirstKey = "{F4}"
        End If
        If keyComFirstKey.Text = "F5" Then
            keyComSelectedFirstKey = "{F5}"
        End If
        If keyComFirstKey.Text = "F6" Then
            keyComSelectedFirstKey = "{F6}"
        End If
        If keyComFirstKey.Text = "F7" Then
            keyComSelectedFirstKey = "{F7}"
        End If
        If keyComFirstKey.Text = "F8" Then
            keyComSelectedFirstKey = "{F8}"
        End If
        If keyComFirstKey.Text = "F9" Then
            keyComSelectedFirstKey = "{F9}"
        End If
        If keyComFirstKey.Text = "F10" Then
            keyComSelectedFirstKey = "{F10}"
        End If
        If keyComFirstKey.Text = "F11" Then
            keyComSelectedFirstKey = "{F11}"
        End If
        If keyComFirstKey.Text = "F12" Then
            keyComSelectedFirstKey = "{F12}"
        End If
    End Sub
    Private Sub keyComSecondKey_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles keyComSecondKey.SelectedIndexChanged
        ...
        If keyComFirstKey.Text = "ESC" Then
            keyComSelectedSecondKey = "{ESC}"
        End If
        'If keyComFirstKey.Text = "Windows" Then
        '    keyComSelectedSecondKey = "{WINDOWS}"
        'End If
        If keyComFirstKey.Text = "Delete" Then
            keyComSelectedSecondKey = "{DELETE}"
        End If
        If keyComFirstKey.Text = "Backspace" Then
            keyComSelectedSecondKey = "{BKSP}"
        End If
        'Arrow Keys
        If keyComFirstKey.Text = "Down Arrow" Then
            keyComSelectedSecondKey = "{DOWN}"
        End If
        If keyComFirstKey.Text = "Up Arrow" Then
            keyComSelectedSecondKey = "{UP}"
        End If
        If keyComFirstKey.Text = "Left Arrow" Then
            keyComSelectedSecondKey = "{LEFT}"
        End If
        If keyComFirstKey.Text = "Right Arrow" Then
            keyComSelectedSecondKey = "{RIGHT}"
        End If
        'Home End Insert
        If keyComFirstKey.Text = "Home" Then
            keyComSelectedSecondKey = "{Home}"
        End If
        If keyComFirstKey.Text = "End" Then
            keyComSelectedSecondKey = "{End}"
        End If
        If keyComFirstKey.Text = "Insert" Then
            keyComSelectedSecondKey = "{INSERT}"
        End If
        'Page up and page down
        If keyComFirstKey.Text = "Page Up" Then
            keyComSelectedSecondKey = "{PGUP}"
        End If
        If keyComFirstKey.Text = "Page Down" Then
            keyComSelectedSecondKey = "{PGDN}"
        End If
        If keyComFirstKey.Text = "Print Screen" Then
            keyComSelectedSecondKey = "{PRTSC}"
        End If
        'Function Keys F1 to F12
        If keyComFirstKey.Text = "F1" Then
            keyComSelectedSecondKey = "{F1}"
        End If
        If keyComFirstKey.Text = "F2" Then
            keyComSelectedSecondKey = "{F2}"
        End If
        If keyComFirstKey.Text = "F3" Then
            keyComSelectedSecondKey = "{F3}"
        End If
        If keyComFirstKey.Text = "F4" Then
            keyComSelectedSecondKey = "{F4}"
        End If
        If keyComFirstKey.Text = "F5" Then
            keyComSelectedSecondKey = "{F5}"
        End If
        If keyComFirstKey.Text = "F6" Then
            keyComSelectedSecondKey = "{F6}"
        End If
        If keyComFirstKey.Text = "F7" Then
            keyComSelectedSecondKey = "{F7}"
        End If
        If keyComFirstKey.Text = "F8" Then
            keyComSelectedSecondKey = "{F8}"
        End If
        If keyComFirstKey.Text = "F9" Then
            keyComSelectedSecondKey = "{F9}"
        End If
        If keyComFirstKey.Text = "F10" Then
            keyComSelectedSecondKey = "{F10}"
        End If
        If keyComFirstKey.Text = "F11" Then
            keyComSelectedSecondKey = "{F11}"
        End If
        If keyComFirstKey.Text = "F12" Then
            keyComSelectedSecondKey = "{F12}"
        End If
    End Sub
